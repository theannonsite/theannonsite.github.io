...
const FILE_DOWNLOADS = [
  'img/angry_squidward_1.png',
  'img/angry_squidward_2.png',
  'img/pixel.png',
  'img/angry_squidward_3.png',
  'img/sad.png',
  'img/angry_squidward_4.png'

]

const PHRASES = [
  'Needs a psyhologist!',
  'Focus I have shizophren',
  'Rah, I don t feel the legs please save!',
  'Am I dying?',
  'Save Philip!',
  'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  'ja yooooo jaa yooooo jaaaa yoooo',
  'yooo yooo yooo yooo yooo yooo yooo yooo',
  'aaaaaaaaaaaaaaaaaa nie czuje nóg',
...
function copySpamToClipboard () {
  const randomArt = getRandomArrayEntry(ART) + '\nCheck out https://theannonsite.github.io'
